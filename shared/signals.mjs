...
//
// รวม 4 เทคนิคที่ใช้กันแพร่หลายในการวิเคราะห์ทางเทคนิค (technical analysis "confluence") เข้าด้วยกัน:
...
// รวมสัญญาณทั้ง 4 แบบเป็นการโหวตเสียงข้างมาก (confluence) — bearish/bullish ต้องได้เสียงเกินครึ่งของสัญญาณที่มีข้อมูลจริง
export function computeSignal(price, candles, returns) {
  ...
  return {
    forecast, rsi, emaFast, emaSlow, bb,
    trendUp, overbought, oversold, nearUpperBand, nearLowerBand,
